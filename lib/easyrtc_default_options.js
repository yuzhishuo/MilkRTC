...
// API Hosting Options
option.apiEnable            = false;                         // Enables hosting of the EasyRTC API files.
option.apiPublicFolder      = "/easyrtc";                   // Api public folder without trailing slash. Note that the demos expect this to be '/easyrtc'
option.apiLabsEnable        = false;                         // Enables hosting of the EasyRTC experimental API files located in the 'labs' sub folder

...
// Application Options
option.appAnonymous         = false;
option.appDefaultName       = "Milk";                    // The default application a connection belongs to if it is not initially specified.
...
option.updateCheckEnable    = false;                         // Checks for updates
...
option.stillAliveGracePeriod = option.stillAliveInterval + 10000;
